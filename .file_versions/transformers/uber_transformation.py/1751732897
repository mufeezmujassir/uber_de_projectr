...
def transform(df, *args, **kwargs):
    ...
    #create the pessenger count dim
    ...
    fact_table=df.merge(passenger_count_dim,on='passenger_count')\
            ...
            [['VendorID','datetime_id','passenger_count_id','trip_distance_id','rate_code_id','store_and_fwd_flag','pickup_location_id','drop_location_id','payment_type_id',
